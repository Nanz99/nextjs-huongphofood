  ...
  return (
    <Layout title="Giỏ Hàng">
      ...
      <Container fixed sx={{ padding: '0 0 64px !important'}}>
          ...
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            ...
            <TableBody>
              ...
              <TableRow sx={{background: '#CDA9220F'}}>
                <TableCell rowSpan={4} />
                <TableCell  align="center" colSpan={2}>Tổng đơn: </TableCell>
                <TableCell align="center">
        ...
        <Stack direction="row" justifyContent="space-between" spacing={2} sx={{marginTop:'32px'}}>
            <NextLink href="/food-new" passHref><Button startIcon={<ArrowBackIcon/>} sx={{color:'#CDA922'}}>Tiếp Tục Mua Hàng</Button>
            </NextLink>
             <NextLink href="/checkout" > 
             <Button variant="contained"  sx={{backgroundColor:'#CDA922', padding: "10px 146px"}}>Đặt hàng</Button>
             </NextLink>
             </Stack>
      </Container>
      </Typography>
